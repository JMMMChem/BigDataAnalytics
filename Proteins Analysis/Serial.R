...
###################CONSTRUCT THE ELBOW GRAPH AND FIND THE OPTIMAL K
...
k_max <- 20
start_time <- Sys.time()
ssd <- sapply(2:k_max, kmeansfunc)
end_time <- Sys.time()
time_taken <- end_time-start_time
sprintf("The time that it took to build the k-ssd matrix is: %f seconds", time_taken)
